...
// Danger
{id:'virage-double-gauche', cat:'danger', num:'105', name:'Double virage (le premier à gauche)', short:'Deux virages, le premier à gauche',
 sens:"Deux virages successifs : d'abord à gauche, puis à droite. Miroir du 104.",
 tip:"Regarde le PREMIER coude de la flèche : c'est lui qui donne la réponse au QCM."},
{id:'retreci-droite', cat:'danger', num:'110', name:'Rétrécissement par la droite', short:'La chaussée se rétrécit à droite',
 sens:"La chaussée devient plus étroite du côté droit.",
 tip:"109 = des deux côtés, 110 = par la droite, 111 = par la gauche. Aucune priorité n'en découle."},
{id:'retreci-gauche', cat:'danger', num:'111', name:'Rétrécissement par la gauche', short:'La chaussée se rétrécit à gauche',
 sens:"La chaussée devient plus étroite du côté gauche.",
 tip:"La priorité dans un passage étroit reste réglée par les panneaux 307/308."},
{id:'balise-obstacle', cat:'danger', num:'112', name:'Balise de passage étroit / obstacle', short:'Obstacle au bord de la chaussée',
 sens:"Passage étroit ou obstacle à l'endroit de la balise. Posée d'un seul côté : l'obstacle est de ce côté ; les lignes diagonales descendent vers le centre de la voie.",
 tip:"Lecture officielle : les rayures descendent du côté où il faut passer — elles « pointent » vers la voie libre."},
{id:'inter-t-gauche', cat:'danger', num:'116', name:'Route latérale à gauche', short:'Débouché latéral à gauche',
 sens:"Une route latérale débouche à gauche. Le trait épais représente TA route.",
 tip:"Miroir du 115. Ces panneaux n'établissent AUCUNE priorité : applique la signalisation du carrefour ou, à défaut, la priorité à droite."},
{id:'inter-t-face', cat:'danger', num:'117', name:'Intersection en T', short:'Ta route se termine en T',
 sens:"Ta route se termine sur une route transversale : il faudra tourner à droite ou à gauche.",
 tip:"Prépare ton clignotant et ta priorité : au T sans signalisation, cède à droite."},
{id:'jonctions', cat:'danger', num:'119-120', name:'Jonctions successives', short:'Deux routes latérales de suite',
 sens:"Deux routes latérales débouchent successivement : à droite puis à gauche (119) ou l'inverse (120).",
 tip:"Même logique que 115/116, mais deux fois de suite — redouble d'attention."},
{id:'fusion', cat:'danger', num:'123-124', name:'Convergence (fusion de routes)', short:'Une route fusionne avec la tienne',
 sens:"Une route prioritaire fusionne avec une route secondaire (de droite ou de gauche). AUCUN virage possible vers la branche.",
 tip:"Différence clé avec 115-117 : ici il y a FUSION, pas carrefour — on ne peut pas tourner vers la branche."},
{id:'balise-pn-200', cat:'danger', num:'131', name:'Balise : passage à niveau à 200 m', short:'Voie ferrée dans 200 m',
 sens:"Passage à niveau à environ 200 mètres (sauf indication différente sur panonceau 630).",
 tip:"2 bandes = 200 m. Le compte à rebours : 3-2-1 bandes = 300-200-100 m."},
{id:'balise-pn-100', cat:'danger', num:'132', name:'Balise : passage à niveau à 100 m', short:'Voie ferrée dans 100 m',
 sens:"Passage à niveau à environ 100 mètres — dernier avertissement avant le passage.",
 tip:"1 bande = 100 m : prépare-toi à t'arrêter à la ligne d'arrêt ou à la croix (133/134)."},
{id:'croix-pn-double', cat:'danger', num:'134', name:'Croix de Saint-André (plusieurs voies)', short:'Passage à niveau à plusieurs voies',
 sens:"Emplacement même d'un passage à niveau comportant PLUSIEURS voies ferrées.",
 tip:"Danger typique : un second train peut arriver juste après le premier, dans l'autre sens. Ne repars pas dès que le premier est passé."},
{id:'tunnel', cat:'danger', num:'138', name:'Tunnel', short:'Tunnel devant toi',
 sens:"Tunnel sur la route devant toi : allume tes feux de croisement, enlève les lunettes de soleil.",
 tip:"Réflexes attendus au QCM : feux allumés, distance de sécurité accrue, interdiction de dépasser si ligne continue."},
{id:'gazelle', cat:'danger', num:'146', name:'Animaux (gazelle)', short:'Animaux sauvages',
 sens:"Des animaux peuvent traverser la route. Deux pictogrammes officiels sous le même numéro : la gazelle… et le chameau.",
 tip:"Même numéro 146 pour la gazelle et le chameau — les deux variantes existent dans le catalogue officiel."},
{id:'tracteur', cat:'danger', num:'147', name:'Engins agricoles / de chantier', short:'Tracteurs traversant',
 sens:"Des véhicules de travaux ou des tracteurs traversent la route (zones agricoles, chantiers).",
 tip:"À ne pas confondre avec 901 (zone de travaux SUR la route) : 147 = des engins TRAVERSENT."},
{id:'accident', cat:'danger', num:'151', name:'Accident', short:'Accident devant toi',
 sens:"Accident de la route plus loin : ralentis fortement, prépare-toi à t'arrêter, ne gêne pas les secours.",
 tip:"Souvent posé temporairement par la police. Interdiction de s'arrêter pour regarder (curiosité = sur-accident)."},
{id:'vent-lateral', cat:'danger', num:'152', name:'Vent latéral', short:'Rafales de vent latéral',
 sens:"Vent latéral fort possible (viaducs, sorties de vallées, Arava) : tiens fermement le volant, réduis la vitesse.",
 tip:"La manche à air indique la direction du vent. Danger accru pour les véhicules hauts et les caravanes."},
{id:'eaux-profondes', cat:'danger', num:'153', name:'Eaux profondes', short:'Risque d\'inondation de la chaussée',
 sens:"Eaux profondes sur la route (oueds, passages inondables du Néguev) : ne t'engage jamais dans l'eau dont tu ne vois pas le fond.",
 tip:"Spécificité israélienne liée aux crues soudaines (שיטפונות) : quelques centimètres d'eau courante suffisent à emporter une voiture."},
{id:'chutes-pierres-gauche', cat:'danger', num:'143', name:'Chutes de pierres (gauche)', short:'Éboulis du côté gauche',
 sens:"Risque de pierres éboulées tombant du talus GAUCHE.",
 tip:"142 = droite, 143 = gauche : le QCM demande parfois de quel côté vient le danger."},
{id:'fin-chantier', cat:'danger', num:'902', name:'Fin de zone de travaux', short:'Fin du chantier',
 sens:"Fin de la zone de travaux commencée au panneau 901 : le marquage orange cesse de s'appliquer.",
 tip:"Après le 902, le marquage BLANC permanent redevient la référence."},
{id:'chevrons-chantier', cat:'danger', num:'903', name:'Chevrons de chantier', short:'Virage guidé en zone de travaux',
 sens:"Guidage dans un virage serré en zone de chantier : ralentis et continue uniquement dans la direction des flèches, en passant devant le panneau.",
 tip:"Même logique que les chevrons 107/108, mais sur fond ORANGE = temporaire."},

// Priorité
{id:'stop-mobile', cat:'priorite', num:'304', name:'STOP mobile (signaleur)', short:'Stop présenté par un signaleur',
 sens:"Arrête-toi ! Panneau mobile tenu par un signaleur (chantiers, contrôles). Reste à l'arrêt jusqu'à autorisation ou jusqu'à l'apparition du panneau 305.",
 tip:"Version RONDE et portative du STOP à main. On ne repart PAS simplement quand la voie semble libre — il faut l'autorisation."},
{id:'avance-prudence', cat:'priorite', num:'305', name:'Avance avec prudence (signaleur)', short:'Le signaleur t\'autorise à passer',
 sens:"Panneau mobile vert « סע » (avance) : le signaleur t'autorise à repartir, avec prudence.",
 tip:"La paire 304/305 fonctionne comme un feu tenu à la main : 304 = rouge, 305 = vert."},

// Interdiction
{id:'barriere', cat:'interdiction', num:'403', name:'Barrière : route bloquée', short:'Route barrée par une barrière',
 sens:"La route est bloquée. Si un panneau de direction est posé, on ne peut avancer que dans la direction indiquée.",
 tip:"Barrière rayée rouge-blanc en travers = route fermée physiquement, pas seulement interdite."},
{id:'barriere-pn', cat:'interdiction', num:'404', name:'Barrière de passage à niveau', short:'Barrière du passage à niveau',
 sens:"Barrière avant un passage à niveau : si elle descend, monte ou est horizontale, ARRÊTE-toi et ne repars pas tant qu'elle n'est pas complètement relevée.",
 tip:"Question classique : barrière EN MOUVEMENT (même en train de remonter) = arrêt obligatoire."},
{id:'camions-poids', cat:'interdiction', num:'406', name:'Interdit aux camions (poids inscrit)', short:'Camions lourds interdits',
 sens:"Entrée interdite aux véhicules utilitaires dont le poids total autorisé dépasse le tonnage inscrit.",
 tip:"Au-dessus d'une voie précise, l'interdiction ne vaut que pour cette voie."},
{id:'interdit-moteur-sauf-2roues', cat:'interdiction', num:'408', name:'Interdit aux véhicules à moteur (sauf deux-roues)', short:'Autos interdites, motos permises',
 sens:"Entrée interdite aux véhicules à moteur, SAUF les deux-roues motorisés.",
 tip:"Le trio 402 / 405 / 408 est un grand classique : tout véhicule / tout moteur / tout moteur sauf deux-roues."},
{id:'interdit-motos', cat:'interdiction', num:'409', name:'Interdit aux motos', short:'Motos interdites',
 sens:"Entrée interdite aux motocyclettes.",
 tip:"Complément inverse du 408 : ici ce sont justement les deux-roues qui sont interdits."},
{id:'interdit-velos', cat:'interdiction', num:'412', name:'Interdit aux vélos', short:'Vélos interdits',
 sens:"Entrée interdite aux vélos (y compris vélos électriques et trottinettes, au sens du catalogue).",
 tip:"Rappel : la définition officielle d'« אופניים » inclut les vélos à assistance électrique."},
{id:'interdit-pietons', cat:'interdiction', num:'413', name:'Interdit aux piétons', short:'Piétons interdits',
 sens:"Entrée interdite aux piétons.",
 tip:"Typique aux abords des autoroutes et tunnels. Sur autoroute, les piétons sont interdits d'office (panneau 216)."},
{id:'poids-limite', cat:'interdiction', num:'415', name:'Poids total limité', short:'Poids maximal autorisé',
 sens:"Entrée interdite à tout véhicule dont le poids total autorisé dépasse le nombre de tonnes inscrit.",
 tip:"406 = utilitaires seulement ; 415 = TOUT véhicule au-dessus du poids inscrit."},
{id:'hauteur-limite', cat:'interdiction', num:'416', name:'Hauteur limitée', short:'Hauteur maximale (chargement compris)',
 sens:"Entrée interdite aux véhicules dont la hauteur — CHARGEMENT COMPRIS — dépasse le nombre de mètres inscrit.",
 tip:"« Chargement compris » est la nuance testée. Voir aussi l'avertissement 113 (obstacle de moins de 4,80 m)."},
{id:'largeur-limite', cat:'interdiction', num:'417', name:'Largeur limitée', short:'Largeur maximale (chargement compris)',
 sens:"Entrée interdite aux véhicules dont la largeur — chargement compris — dépasse le nombre de mètres inscrit.",
 tip:"Même logique que le 416, mais pour la largeur (flèches horizontales au lieu de verticales)."},
{id:'fin-depassement', cat:'interdiction', num:'421', name:'Fin d\'interdiction de dépasser', short:'Le dépassement redevient permis',
 sens:"Fin de la section où le dépassement était interdit (panneau 420).",
 tip:"L'interdiction du 420 tombe aussi d'elle-même au prochain carrefour — le 421 sert en section courante."},
{id:'depassement-camions', cat:'interdiction', num:'422', name:'Dépassement interdit aux camions', short:'Les >4 t ne dépassent pas',
 sens:"Les véhicules de plus de 4 tonnes ne doivent pas dépasser de véhicule à moteur à plus de deux roues. Valable jusqu'au prochain carrefour.",
 tip:"Ne te concerne pas en voiture… mais explique pourquoi le camion devant toi ne double pas. La paire 422/423 = le 420/421 des poids lourds."},

// Obligation
{id:'fourche-droite', cat:'obligation', num:'201', name:'Tout droit ou à droite', short:'Continuer tout droit ou tourner à droite',
 sens:"Va tout droit ou tourne à droite. Une flèche JAUNE sur ce type de panneau désigne la direction réservée aux transports publics.",
 tip:"Nuance officielle : sous le 201, le demi-tour à droite reste PERMIS (contrairement au 203 qui interdit le demi-tour)."},
{id:'fourche-gauche', cat:'obligation', num:'202', name:'Tout droit ou à gauche', short:'Continuer tout droit ou tourner à gauche',
 sens:"Va tout droit ou tourne à gauche. Le demi-tour à gauche reste permis, sauf panneau contraire.",
 tip:"Texte officiel : « פנית פרסה שמאלה מותרת » — le demi-tour à gauche est explicitement permis sous le 202."},
{id:'oblig-gauche-apres', cat:'obligation', num:'207', name:'À gauche APRÈS le panneau', short:'Tourner à gauche après le panneau',
 sens:"Tourne à gauche — vire APRÈS le panneau. Le demi-tour à gauche reste permis sauf interdiction.",
 tip:"204/206 (droite) et 205/207 (gauche) : flèche horizontale = avant le panneau, flèche coudée = après."},
{id:'droite-ou-gauche', cat:'obligation', num:'208', name:'À droite ou à gauche', short:'Interdiction de continuer tout droit',
 sens:"Tourne à droite OU à gauche — tout droit interdit. Le demi-tour est permis des deux côtés sauf panneau contraire.",
 tip:"La flèche officielle est FOURCHUE (un fût, deux pointes). Souvent en bout de rue en T."},
{id:'demi-tour-droite-permis', cat:'obligation', num:'209', name:'Tout droit ou demi-tour à droite', short:'Demi-tour à droite autorisé',
 sens:"Va tout droit ou fais demi-tour vers la DROITE ; le demi-tour à gauche est interdit ici.",
 tip:"Oui, le demi-tour à droite existe en Israël (rues à sens unique parallèles) — les panneaux bleus 209-212 l'organisent."},
{id:'demi-tour-gauche-permis', cat:'obligation', num:'210', name:'Tout droit ou demi-tour à gauche', short:'Demi-tour à gauche autorisé',
 sens:"Va tout droit ou fais demi-tour vers la GAUCHE ; le demi-tour à droite est interdit ici.",
 tip:"À l'inverse des interdictions 430/431 (rondes rouges), les 209-212 (bleus) AUTORISENT explicitement le demi-tour."},
{id:'vitesse-minimale', cat:'obligation', num:'218', name:'Vitesse minimale', short:'Rouler AU MOINS à la vitesse inscrite',
 sens:"Route réservée aux véhicules capables et autorisés de rouler AU MOINS à la vitesse inscrite. Valable jusqu'au prochain carrefour ou au panneau 217.",
 tip:"Rond BLEU + chiffre = minimum ; rond ROUGE + chiffre = maximum. Piège visuel favori du QCM."},
{id:'voie-cyclable', cat:'obligation', num:'224', name:'Voie cyclable à sens unique', short:'Voie réservée aux vélos (sens unique)',
 sens:"Voie à sens unique réservée aux vélos (y compris électriques) : circulation uniquement dans le sens marqué.",
 tip:"224 = VOIE (נתיב) sur la chaussée ; 227 = CHEMIN (שביל) séparé. Fin de voie cyclable : 225."},
{id:'chemin-partage', cat:'obligation', num:'228', name:'Chemin partagé piétons-vélos', short:'Piétons et vélos ensemble',
 sens:"Chemin PARTAGÉ entre piétons et vélos : les deux cohabitent sur le même espace.",
 tip:"228 = ensemble sur le même chemin ; 229 = chacun sa moitié, séparée par une ligne."},
{id:'chemins-separes', cat:'obligation', num:'229', name:'Chemins séparés piétons | vélos', short:'Chacun de son côté de la ligne',
 sens:"Chemin séparé : une partie réservée aux piétons, l'autre aux vélos, chacun de son côté conformément aux pictogrammes.",
 tip:"Regarde de quel côté est le vélo sur le panneau : c'est ce côté-là du chemin qui lui est réservé."},

// Indication
{id:'arret-bus', cat:'indication', num:'505', name:'Arrêt d\'autobus', short:'Station de bus',
 sens:"Station d'autobus et de véhicules de lignes de service : arrêt selon les indications du panneau. Interdiction d'y arrêter ou stationner un autre véhicule (~20 m de part et d'autre).",
 tip:"Au sol : bordures rouge-jaune. Ta voiture n'a pas le droit de s'y arrêter « même une minute »."},
{id:'station-taxi', cat:'indication', num:'509', name:'Arrêt taxi (montée/descente)', short:'Arrêt réservé aux taxis',
 sens:"Emplacement d'arrêt réservé aux taxis pour la montée et la descente de passagers uniquement : arrêt et stationnement interdits à tout autre véhicule.",
 tip:"Comme l'arrêt de bus : bordures rouge-jaune, interdiction totale pour les autres véhicules. (La station de taxis proprement dite est le panneau 507.)"},
{id:'voies-plus', cat:'indication', num:'619', name:'Le nombre de voies augmente', short:'Une voie s\'ajoute',
 sens:"Le nombre de voies augmente (par la droite ou la gauche selon la variante). Une flèche JAUNE désigne une voie réservée aux transports publics.",
 tip:"Une voie qui s'AJOUTE ne donne aucune priorité particulière — chacun garde sa voie."},
{id:'voies-moins', cat:'indication', num:'621', name:'Le nombre de voies diminue', short:'Une voie se termine',
 sens:"Le nombre de voies diminue (par la droite ou la gauche selon la variante) : les véhicules de la voie qui se termine s'insèrent dans la voie voisine.",
 tip:"Celui qui CHANGE de voie cède la priorité à celui qui y est déjà. Au sol : flèches de rabattement (814)."},
{id:'impasse-droite', cat:'indication', num:'624', name:'Impasse à droite', short:'La rue à droite est sans issue',
 sens:"La rue qui débouche à DROITE au prochain croisement est une impasse (625 : à gauche). Ta propre route continue.",
 tip:"Le T déporté sur le côté du panneau = l'impasse concerne la rue latérale, pas la tienne (623 = la tienne)."},
{id:'parking-trottoir', cat:'indication', num:'627', name:'Stationnement sur le trottoir autorisé', short:'Stationner sur le trottoir (≤ 2 200 kg)',
 sens:"Stationnement sur le trottoir autorisé pour les véhicules de 2 200 kg maximum, selon le schéma marqué, SANS bloquer le passage des piétons et fauteuils roulants.",
 tip:"Deux conditions cumulatives très testées : ≤ 2 200 kg ET laisser un passage raisonnable aux piétons/fauteuils."},
{id:'place-handicape', cat:'indication', num:'437', name:'Stationnement réservé handicapés', short:'Place réservée (carte de stationnement)',
 sens:"Stationnement EXCLUSIF pour un véhicule portant une carte de stationnement handicapé valide, quand le véhicule sert la personne titulaire.",
 tip:"Nuance officielle : la carte doit être valide ET le véhicule doit servir la personne handicapée à ce moment-là."},

// Marquage
{id:'voie-reversible', cat:'marquage', num:'802', name:'Voie réversible (double discontinue)', short:'Voie à sens alterné',
 sens:"Voie encadrée par une double ligne discontinue : n'y roule PAS, sauf si un panneau ou un feu placé au-dessus l'autorise.",
 tip:"Voie « dynamique » : sans signal au-dessus qui l'ouvre dans ton sens, elle t'est interdite."},
{id:'tirets-denses', cat:'marquage', num:'805', name:'Tirets rapprochés (avertissement)', short:'La ligne continue approche',
 sens:"Tirets blancs rapprochés : une ligne de séparation continue (double) commence bientôt — rabats-toi sur la voie de droite AVANT son début.",
 tip:"Si tu es en plein dépassement quand les tirets se resserrent : termine et rabats-toi avant la ligne continue."},
{id:'ligne-rectangles', cat:'marquage', num:'808', name:'Ligne de rectangles', short:'Voie spécialisée (tourne / insertion)',
 sens:"Ligne de rectangles blancs : voie réservée à un mouvement (tourne-à-droite/gauche exclusif, accélération, décélération, entrecroisement) — roule selon la destination de la voie.",
 tip:"Si ta voie devient « tourne-à-droite exclusif » (flèche au sol), tu dois tourner — ou en sortir avant la ligne de rectangles."},
{id:'guide-virage', cat:'marquage', num:'809', name:'Ligne de guidage de virage', short:'Suivre la courbe dans le carrefour',
 sens:"Ligne discontinue incurvée dans le carrefour : tourne en roulant parallèlement à elle. Le demi-tour y est PERMIS sauf interdiction par panneau.",
 tip:"Point souvent ignoré : cette ligne autorise par défaut le demi-tour (פניית פרסה מותרת)."},
{id:'zebra', cat:'marquage', num:'811', name:'Passage piétons (zébrures)', short:'Passage piétons au sol',
 sens:"Passage pour piétons. S'il est large et divisé en deux, le piéton traverse dans la moitié DROITE.",
 tip:"Ne jamais s'arrêter dessus, ni dans les 12 m avant, ni dépasser un véhicule arrêté devant."},
{id:'passage-velos', cat:'marquage', num:'812', name:'Passage pour vélos', short:'Traversée cyclable',
 sens:"Passage de traversée pour les vélos, marqué par des rangées de carrés blancs.",
 tip:"Deux rangées de carrés blancs = vélos ; zébrures pleines = piétons. Sois attentive aux cyclistes qui s'y engagent, surtout en tournant."},
{id:'fleches-voie', cat:'marquage', num:'813', name:'Flèches directionnelles', short:'Directions permises dans ta voie',
 sens:"Flèches blanches au sol : n'entre dans le carrefour et ne le traverse que dans la direction de la flèche marquée dans TA voie d'approche.",
 tip:"La flèche de ta voie t'engage dès l'entrée du carrefour. En zone de chantier, la version ORANGE (926) prime."},
{id:'fleches-rabattement', cat:'marquage', num:'814', name:'Flèches de rabattement', short:'Ta voie va se terminer',
 sens:"Flèches diagonales blanches : la voie se termine — passe sur la voie adjacente dans la direction des flèches.",
 tip:"À distinguer du 813 : diagonale = la voie disparaît, anticipe le rabattement (et cède à ceux déjà dans l'autre voie)."},
{id:'ilot-peint', cat:'marquage', num:'815', name:'Îlot peint (zone hachurée)', short:'Zone interdite au roulage',
 sens:"Îlots de canalisation marqués en blanc sur la chaussée : interdiction de les franchir, de s'y arrêter et d'y stationner.",
 tip:"TROIS interdits cumulés : franchir, s'arrêter, stationner. Version chantier : orange (928)."},
{id:'cases-stationnement', cat:'marquage', num:'819', name:'Cases de stationnement', short:'Stationner DANS les cases',
 sens:"Emplacements de stationnement délimités en blanc : ne stationne qu'à l'INTÉRIEUR du périmètre marqué. Sur trottoir avec panneau 627 : réservé aux ≤ 2 200 kg, sans bloquer les piétons.",
 tip:"Le 820 (périmètre blanc SANS cases) marque au contraire une zone où le stationnement est interdit."},
{id:'voie-bus-marquage', cat:'marquage', num:'515-516', name:'Voie bus : lignes jaunes et losanges', short:'Voie réservée (losanges jaunes)',
 sens:"Ligne jaune double continue + losanges jaunes = voie de transport public infranchissable (515). Avec segment discontinu (516) : on peut la traverser en franchissant d'abord la ligne discontinue.",
 tip:"Losanges jaunes au sol = נת\"צ (voie bus). Continue = infranchissable ; discontinue = entrée/sortie permise. Flèches JAUNES au sol (514) = pour les bus uniquement."},
];
...
const CAT_ORDER = ['danger', 'priorite', 'interdiction', 'obligation', 'indication', 'marquage'];
...
const unused = Object.keys(SVGS).filter(id => !META.some(m => m.id === id));
if (unused.length) throw new Error('SVG sans fiche META: ' + unused.join(', '));
